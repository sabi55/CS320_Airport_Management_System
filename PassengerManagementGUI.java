...
public class PassengerManagementGUI {
    ...
    public PassengerManagementGUI() {
        ...
        String[] columnNames = {"Passenger ID", "Name", "Surname", "Passenger Type", "Luggage Count", "Year of Birth"};
            ...
            public void actionPerformed(ActionEvent e) {
                if (Integer.parseInt(yearOfBirth.getText()) < 1900 || Integer.parseInt(yearOfBirth.getText()) > 2023) {
                    ...
                    try (Connection connection = DatabaseConnection.getConnection();
                        ...
                        JOptionPane.showMessageDialog(panel, "Passenger added successfully!");
        ...
        removeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try (Connection connection = DatabaseConnection.getConnection();
                    ...
                    if (rowsAffected > 0) {
                        JOptionPane.showMessageDialog(panel, "Passenger removed successfully!");
                    } else {
                        JOptionPane.showMessageDialog(panel, "Passenger not found.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (SQLException ex) {
                    ex.printStackTrace();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Integer.parseInt(yearOfBirth.getText()) < 1900 || Integer.parseInt(yearOfBirth.getText()) > 2023) {
                    ...
                    try (Connection connection = DatabaseConnection.getConnection();
                        ...
                        preparedStatement.executeUpdate();
                        JOptionPane.showMessageDialog(panel, "Passenger updated successfully!");
                    } catch (SQLException ex) {
                        ex.printStackTrace();
