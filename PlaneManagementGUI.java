...
public class PlaneManagementGUI {
    ...
    public PlaneManagementGUI() {
        ...
        // String input fields
        JLabel label1 = new JLabel("Plane ID");
            ...
            public void actionPerformed(ActionEvent e) {
                if ((int) capacity.getValue() <= 0) {
                    ...
                    try (Connection connection = DatabaseConnection.getConnection();
                        ...
                        JOptionPane.showMessageDialog(panel, "Plane added successfully!");
        ...
        JButton removeButton = new JButton("Remove Plane");
        removeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try (Connection connection = DatabaseConnection.getConnection();
                    ...
                    if (rowsAffected > 0) {
                        JOptionPane.showMessageDialog(panel, "Plane deleted successfully!");
                    } else {
                        JOptionPane.showMessageDialog(panel, "Plane not found.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (SQLException ex) {
                    ex.printStackTrace();
        ...
        JLabel lblNewLabel_1 = new JLabel("Hangar Status");
        ...
        JLabel lblNewLabel_1_1 = new JLabel("Runway Status");
        ...
        JLabel lblNewLabel = new JLabel("Hangar Id");
        ...
        JButton btnAddRunway = new JButton("Add Runway");
        ...
        JButton btnRemoveRunway = new JButton("Remove Runway");
        ...
        JButton btnReserveRunway = new JButton("Reserve Runway");
        ...
        JButton btnResetRunway = new JButton("Reset Runway");
        ...
        JLabel lblRunwayId = new JLabel("Runway Id");
    ...
    private void setStatusArea(JTextArea textArea, ArrayList<Runway> runways) {
        ...
        for (Runway runway : runways) {
            if (runway.getPlane() == null) {
                txt += "Runway " + runway.getRunwayId() + " is empty.\n";
            } else {
                txt += "Runway " + runway.getRunwayId() + " is reserved by " + runway.getPlane().getPlaneId() + ".\n";
            }
        }
    ...
    private void setHangarStatusArea(JTextArea textArea, ArrayList<Hangar> hangars) {
        ...
        for (Hangar hangar : hangars) {
            if (hangar.getPlane() == null) {
                txt += "Hangar " + hangar.getHangarId() + " is empty.\n";
            } else {
                txt += "Hangar " + hangar.getHangarId() + " is reserved by " + hangar.getPlane().getPlaneId() + ".\n";
            }
        }
        textArea.setText(txt);
    }
